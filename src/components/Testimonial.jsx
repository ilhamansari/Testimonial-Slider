...
export const Testimonial = (props) => {
  ...
  return (
    <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl orunded-md">
